...
while True:
    ...
    yanal=75*leftyaxis*kademe_yuzde
    dikey=75*rightyaxis*kademe_yuzde
    donme=75*leftxaxis*kademe_yuzde
    kayma=75*hatx*kademe_yuzde
    ...
    if Guc==1:
        ...
        if R1==1 and kademe!=100:
            kademe=kademe + 50
        if R2==1 and 50!=kademe:
            kademe=kademe - 50
        #-----------------------------------------Kademe Bitti--------------------------------
        
        #--------------------------------------------motor yön-------------------------------
        pwm.set_pwm(0,0,int(311+dikey))
        pwm.set_pwm(1,0,int(311+dikey))
