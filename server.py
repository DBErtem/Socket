...
while True:
    ...
    packed_msg_size = data[:payload_size] #Gelen mesajın sıkıştırılmış boyutu
    data = data[payload_size:]            #Gelen mesaj
    msg_size = struct.unpack(">L", packed_msg_size)[0] #Gelen mesajın sıkıştırılmamış boyutu
